...
extern BITMAPFILEHEADER *pSrcFileHdr, *pTgtFileHdr;
extern BITMAPINFOHEADER *pSrcInfoHdr, *pTgtInfoHdr;
extern RGBQUAD *pSrcColorTable, *pTgtColorTable;
extern unsigned char *pSrcFile, *pTgtFile, *pSrcData, *pTgtData;
extern int srcFileSize, tgtFileSize;

extern unsigned char gNumLSB, gMask, gShift;
extern unsigned char gAndMask[8][8];
