...
public:
  ...
  virtual void WriteImage (std::ostream &strm,
                           BitmapImage &image) ;
...
//jao this was my attempt
//JpegEncoderQuantizationTable *GetQuantizationValue (unsigned int index);
//static JpegEncoderQuantizationTable *JpegEncoder::GetQuantizationValue (unsigned int index)
//{
//	return(chrominance_quanttbl);
//}
  ...
  unsigned int image_quality ; // jao
